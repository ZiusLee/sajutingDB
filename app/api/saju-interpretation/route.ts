...
한국어로 친절하게 설명해주세요. 마크다운 형식으로 응답해주세요. 적절한 이모지를 사용하여 가독성을 높여주세요.`
    ...
    try {
      ...
      const { text } = await generateText({
        ...
        system:
          "당신은 사주팔자 전문가입니다. 사주에 대한 해석과 궁합이 좋은 사주 조합을 ���공해주세요. 마크다운 형식으로 응답해주세요. 제목과 소제목을 사용하고, 내용은 구체적으로 작성해주세요. 적절한 이모지를 사용하여 가독성을 높여주세요. 특히 연애운의 흐름에 대해서는 일관성 있게 답변해주세요. 같은 사주에 대해서는 항상 동일한 시기를 연애운이 강하거나 약한 시기로 제시해야 합니다. 연애운 예측은 사주의 일간, 오행 분석, 대운을 기반으로 체계적으로 도출해주세요",
      })
